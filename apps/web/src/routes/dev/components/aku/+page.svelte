			...
			{#snippet left()}
				<div class="flex items-start gap-2.5">
					...
					<div class="min-w-0 flex-1">
						<p class="truncate text-h3 font-semibold leading-tight text-foreground">
							{profile.name}
						</p>
						...
						<div class="mt-1 flex flex-nowrap items-center gap-1">
							...
							{#if showFlameBadge}
								<span
									class="inline-flex items-center gap-0.5 rounded-full border border-peringatan/30 bg-peringatan/10 px-2 py-0.5 text-xs leading-tight font-medium text-peringatan"
								>
