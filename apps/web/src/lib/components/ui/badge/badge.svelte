	...
	export const badgeVariants = tv({
		...
		variants: {
			variant: {
				...
				'track-tuntaskan': 'bg-tuntaskan-soft border-transparent text-tuntaskan',
				'track-wujudkan': 'bg-wujudkan-soft border-transparent text-wujudkan',
				'track-telusuri': 'bg-telusuri-soft border-transparent text-telusuri',
				'track-rayakan': 'bg-rayakan-soft border-transparent text-rayakan',
				'track-musyawarah': 'bg-musyawarah-soft border-transparent text-musyawarah',
