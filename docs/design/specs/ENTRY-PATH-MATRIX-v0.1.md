...
| **Track hint** | Auto-generated by AI (dynamic labels) | None | None | None (concept pills for filtering) |
...
> **Auto-track (supersedes fixed mapping):** Tracks are now **dynamically generated by AI** based on the content's RDF triples and conversational context — not fixed to predefined labels. AI-00 proposes a contextually appropriate track label as part of triage. The old fixed 5-label mapping (Tuntaskan/Wujudkan/Telusuri/Rayakan/Musyawarah to Schema.org Action types) is obsolete. Track hints remain UI display labels only — they do not drive lifecycle.

Phase patterns are also dynamic — the LLM proposes context-appropriate phases for each case. See `ADAPTIVE-PATH-SPEC-v0.1.md`.
...
|---|---|---|---|
| "Jalan berlubang di depan rumah saya" | `schema:RepairAction` | Komunitas | *(AI-generated)* |
| "Kita bangun pos ronda baru yuk" | `schema:CreateAction` | Komunitas | *(AI-generated)* |
| "Kenapa air PDAM sering mati?" | `schema:SearchAction` | Komunitas | *(AI-generated)* |
| "Pak RT kita menang lomba!" | `schema:AchieveAction` | Komunitas | *(AI-generated)* |
| "Iuran sampah mau dinaikkan, setuju?" | `schema:AssessAction` | Komunitas | *(AI-generated)* |
