...
**Feed-First.** The home screen is a living feed of community activity. Each entity is a card that changes face based on its current stage. Users scroll to see what's happening, tap to go deeper. The feed is the heartbeat of the community.
...
**Witness Narrative.** Every witness is a story with chapters. The engagement loop is narrative progression: "did my report lead to a real solution?" Users come back because they're invested in outcomes, not chasing likes.

**Smart Urgency.** Notifications respect attention by default (daily digest) but escalate to real-time when it matters (challenge windows closing, tasks stalling). The system earns the right to interrupt.
