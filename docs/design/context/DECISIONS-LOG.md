...
| # | Decision | Rationale | Status |
|---|---|---|---|
| S3-A1 | Track hints and ranah are NOT separate dimensions — they're unified in the RDF triple model. Schema.org Action type drives mode routing. Wikidata hierarchy replaces ranah for domain classification. Track hints are now auto-generated by AI, not derived from a fixed Action type mapping. | See S3-MD1 and S3-MD2. Eliminates confusion about whether track_hint and ranah overlap or conflict. | CONFIRMED |
...
|---|---|---|
| S1-02: Track hints as separate classification | Track hints now auto-generated by AI (not fixed to 5 labels or derived from Action types) | S3-MD2 |
