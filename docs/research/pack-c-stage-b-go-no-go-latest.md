...
|---|---:|---:|---|---|---:|---:|---|---|
| Edge error ratio | n/a | n/a | >0.0005 for 10m | >0.002 for 5m | 0/10 | 0/5 | SKIPPED | dry-run (no Prometheus query executed) |
| Edge partial ratio | n/a | n/a | >0.001 for 10m | >0.005 for 5m | 0/10 | 0/5 | SKIPPED | dry-run (no Prometheus query executed) |
| Shadow mismatch increase[30m] | n/a | n/a | >1 for 5m | >5 for 5m | 0/5 | 0/5 | SKIPPED | dry-run (no Prometheus query executed) |
